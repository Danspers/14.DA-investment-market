...
База данных хранит информацию о венчурных фондах и инвестициях в компании-стартапы. Эта база данных основана на датасете Startup Investments, опубликованном на платформе Kaggle.
...
Опичания запросов содержится в текстовом файле [requests_description.md](https://github.com/Danspers/14.DA-investment-market/blob/main/requests_description.md)